...
public class AutoScrollTextView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public AutoScrollTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ZCITCAD_AutoScrollTextView);
        color =   ta.getColor(R.styleable.ZCITCAD_AutoScrollTextView_mhPrimaryColor, 0xff999999);
